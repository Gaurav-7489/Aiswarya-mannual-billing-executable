...
type SceneMesh = { geometry?: Disposable; material?: Disposable | Disposable[] }
...
export default function PremiumScene({ mode = 'ambient' }: { mode?: SceneMode }) {
  ...
  useEffect(() => {
    ...
    void import('three').then((THREE) => {
      ...
      if (mode === 'ambient') {
        body.scale.set(0.78, 0.78, 0.78); face.scale.set(0.78, 0.78, 0.78); slot.scale.set(0.78, 0.78, 0.78); paper.scale.set(0.78, 0.78, 0.78); group.position.set(0, 0.18, 0)
      }
      const resize = () => {
      ...
      cleanup = () => {
        ...
        scene.traverse((object) => {
          const mesh = object as unknown as SceneMesh
